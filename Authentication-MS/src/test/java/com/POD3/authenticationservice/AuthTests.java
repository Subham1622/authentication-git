package com.POD3.authenticationservice;
...
import com.POD3.authenticationservice.service.JwtUtil;
...
public class AuthTests {
	...
	public void login() throws JsonProcessingException, Exception {
		AppUser menu = new AppUser("EMPLOYEE101", "employee", "employee", "eyToken", "EMPLOYEE");
		String json = mapper.writeValueAsString(menu);
	...
	public void login2() throws JsonProcessingException, Exception {
		AppUser menu = new AppUser("EMPLOYEE101", "employee", "employee", "", "EMPLOYEE");
		String json = mapper.writeValueAsString(menu);
